...
We analyze the effects on true-model selection rates and runtime to assess performance using BIC as a point of reference. In our finite sample setting, we find that screening substantially shifts the balance toward runtime gains while reducing selection accuracy.